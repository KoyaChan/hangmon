// hangmon.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_HANGMON, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_HANGMON));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_HANGMON);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   static HWND hWnd = CreateWindowW(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
...
{
	static CMessageMaker cMessageMaker;
	static CTargetProcess cTargetProcess;
	...
	case WM_CREATE:
	{
		...
		DWORD dwThreadId;
		hThread = CreateThread(NULL, 0, StatusCheckerThread, (LPVOID)&cStatusChecker, 0, &dwThreadId);
